...
def train_all_horizons(
    ...
    os.makedirs(MODEL_DIR, exist_ok=True) if save else None
    ...
    for h in HORIZONS:
        ...
        if save:
            joblib.dump(models[h], f"{MODEL_DIR}/lgbm_h{h:02d}.pkl")
